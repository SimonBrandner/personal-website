		...
		<View className="CV">
			<React.Fragment>
				<CVSection name={t("cv.generalSkills", "General Skills")}>
					<CVPart
						name={t("cv.languages", "Languages")}
					>
						<ul>
							<li><Trans i18nKey="cv.english">English — C1</Trans></li>
							<li><Trans i18nKey="cv.spanish">Spanish — A2</Trans></li>
							<li><Trans i18nKey="cv.czech">Czech — native speaker</Trans></li>
						</ul>
					</CVPart>
				</CVSection>
				<CVSection name={t("cv.programmingAndItSkills", "Programming and IT Skills")}>
					<CVPart
						name={t("cv.general", "General")}
					>
						<ul>
							<li>
							...
							<li>
								<Trans i18nKey="cv.rasterGraphicsEditors">
									Raster graphics editors: GIMP, Krita, Affinity Photo 
								</Trans>
							</li>
							<li>
								<Trans i18nKey="cv.vectorGraphicsEditors">
									Vector graphics editors: Inkscape, Figma 
								</Trans>
							</li>
							<li>
								<Trans i18nKey="cv.videoEditors">
									Video editors: DaVinci Resolve 
								</Trans>
							</li>
							<li>
								<Trans i18nKey="cv.operatingSystems">
					...
					<CVPart
						name={t("cv.programmingLanguages", "Programming Languages")}
					>
						<ul>
							<li>
					...
					<CVPart
						name={t("cv.markupAndStyleSheetLanguages", "Markup and Style Sheet Languages")}
					>
						<ul>
							<li>LaTeX — <Trans i18nKey="cv.intermediate"> intermediate</Trans></li>
							<li>Markdown — <Trans i18nKey="cv.intermediate">intermediate</Trans></li>
							<li>HTML — <Trans i18nKey="cv.intermediate">intermediate</Trans></li>
							<li>CSS/SCSS — <Trans i18nKey="cv.intermediate">intermediate</Trans></li>
							<li>QML — <Trans i18nKey="cv.elementary">elementary</Trans></li>
						</ul>
					</CVPart>
					<CVPart
						name={t("cv.technologies", "Technologies")}
					>
						<ul>
							<li>
								<Trans i18nKey="cv.webAppFrameworks/libraries">
									Web app frameworks/libraries
								</Trans>: React, Angular
							</li>
							<li>
								<Trans i18nKey="cv.communication">
									Communication
								</Trans>: Matrix, WebRTC
							</li>
							<li>
								<Trans i18nKey="cv.gameEngines">
									Game engines
								</Trans>: Unreal Engine (Blueprints)
							</li>
						</ul>
					</CVPart>
				</CVSection>
				<CVSection name={t("cv.workExperiences", "Work Experiences")}>
					...
					>
						<ul>
							<li>
								<Trans i18nKey="cv.workingOnElementWebDesktop">
									Working on Element Web/Desktop
								</Trans>
							</li>
							<li>
								<Trans i18nKey="cv.workingOnElementCall">
									Working on Element Call
								</Trans>
							</li>
							<li>
								<Trans i18nKey="cv.workingOnWaterfall">
									Working on Waterfall
								</Trans>
							</li>
							<li>
								<Trans i18nKey="cv.workingOnSpec">
									Working on the Matrix specification
								</Trans>
							</li>
							<li>
								<Trans i18nKey="cv.workingOnOtherRelatedProjects">
									Occasionally working on other related projects
								</Trans>
							</li>
							<li>
								<Trans i18nKey="cv.workingOnTheVoipTeam">
									Working on the VoIP team
								</Trans>
							</li>
							<li>
								<Trans i18nKey="cv.mentoring">
					...
					>
						<p>
							<Trans i18nKey="cv.highSchoolThesisDescription">
								...
								Video Calls (Využití protokolu Matrix pro videohovory). The
								<a 
				...
				<CVSection name={t("cv.projects", "Projects")}>
					<CVPart
						name="GitHub"
						from={t("cv.January", "January") + " 2019"}
					>
						<p>
					...
					>
						<ul>
							...
							<li>
								<Trans i18nKey="cv.voipFeatures">
									Implemented new VoIP features
								</Trans>
							</li>
							<li>
								<Trans i18nKey="cv.numerousFeatures">
									Added numerous features
								</Trans>
							</li>
							<li>
								<Trans i18nKey="cv.numerousBugs">
									Fixed numerous bugs
								</Trans>
							</li>
						</ul>
					...
					>
						<ul>
							<li>
								<Trans i18nKey="cv.implementedMSC2285">
					...
					>
						<ul>
							<li>
								<Trans i18nKey="cv.rewroteWidget">
					...
					>
						...
						<ul>
							<li><Trans i18nKey="cv.nestedTasks">Nested tasks</Trans></li>
							<li><Trans i18nKey="cv.scheduling">Scheduling</Trans></li>
							<li><Trans i18nKey="cv.projectImporting">Project importing</Trans></li>
							<li><Trans i18nKey="cv.trayIcon">System tray icon</Trans></li>
							<li><Trans i18nKey="cv.keyboardShortcuts">Keyboard shortcuts</Trans></li>
							<li><Trans i18nKey="cv.repeatedTasks">Repeated tasks</Trans></li>
							<li><Trans i18nKey="cv.repeatPRresets">Repeat presets</Trans></li>
							<li><Trans i18nKey="cv.multipleThemes">Multiple themes</Trans></li>
							<li><Trans i18nKey="cv.reminders">Reminders</Trans></li>
						</ul>
					</CVPart>
					<CVPart
						name="YeelightCPPAPI"
